        ...
        switch(event.keyCode) {
            case 37: // 左
                ...
                if (col < 0 || $$(row + '_' + col).className == 'wall') {
                    return;
                }else if($$(row + '_' + col).className == 'real' && $$(row + '_' + (col-1)).className == 'real'){

                    col++;
                    return;

                }else if($$(row + '_' + col).className == 'arrive' && $$(row + '_' + (col-1)).className == 'real'){
            ...
            case 38: // 上
                direction = 'u';
                row--;
                if( $$(row + '_' + col).className == 'real'&& $$((row-1) + '_' + col).className == 'real'){
                    row++;
                    return;
                }
                if( $$(row + '_' + col).className == 'arrive'&& $$((row-1) + '_' + col).className == 'real'){
                    row++;
                    return;
                }
            ...
            case 39: // 右
                direction = 'r';
                col++;
                if( $$(row + '_' + col).className == 'real'&& $$(row + '_' + (col+1)).className == 'real'){
                    col--;
                    return;
                }
                if( $$(row + '_' + col).className == 'arrive'&& $$(row + '_' + (col+1)).className == 'real'){
                    col--;
                    return;
                }
